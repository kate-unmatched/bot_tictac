 ...
 * total strength is subtracted from the score and the current haslam.blackstone.players
...
public class Evaluator {
     ...
     * @return Score from the current haslam.blackstone.players perspective
     */
